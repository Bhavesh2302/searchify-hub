...
import { updateBrand, updateCategory, updateGender, updateSort } from "../Redux/filterReducer/action";
  ...
  return (
    <div className="w-full h-full font-semibold lg:text-base md:text-sm sm:text-xs pl-10 mt-[12px]">
      ...
      <div className="w-full mb-4 mt-2">
        <div className="font-bold mb-2 text-left">Filter By Category</div>
        <div>
          <div className="w-full flex items-center justify-start gap-1.5 mb-2 text-[#646464]">
            <input
              type="Checkbox"
      ...
      <div className="w-full mb-4">
        <div className="font-bold mb-2 text-left">Filter By Gender</div>
        <div>
          <div className="w-full flex items-center justify-start gap-1.5 mb-2 text-[#646464]">
            <input
              type="Checkbox"
      ...
      <div>
        <div className="font-bold mb-2 text-left">Sort By Price</div>
        <div className="w-full flex items-center justify-start gap-1.5 mb-2 text-[#646464]">
          <input
            type="radio"
            className="w-4 h-4"
